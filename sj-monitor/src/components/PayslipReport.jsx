  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded border">
        <h1 className="text-2xl font-bold mb-2">Laporan Gaji Supir</h1>
        <p className="text-gray-600">Periode: {periodLabel}</p>
      </div>

      {/* Driver Selector */}
      <div className="bg-white p-4 rounded border">
        <label className="block font-medium mb-2">Pilih Supir:</label>
        <select
